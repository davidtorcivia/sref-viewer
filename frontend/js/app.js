    ...
    if (!modal) {
        ...
        modal.innerHTML = `
            <div class="modal-content">
                ...
                <h3>SREF vs REFS</h3>
                <p>SREF retires on <strong>October 6, 2026</strong>. Its successor is <strong>REFS</strong> (the RRFS ensemble) at 3km resolution, cycles at 00Z/06Z/12Z/18Z. NOAA does not publish the individual REFS members, so the REFS view shows the <strong>deterministic RRFS</strong> run as an hourly line and the <strong>REFS ensemble mean</strong> with a band of mean &plusmn; spread (3-hourly to 60 hours). Use the model toggle in the header to switch.</p>
